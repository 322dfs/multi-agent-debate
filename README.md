...
### 2) 辩题输入页
![辩题输入页](./images/screenshot-02.png)
说明：输入问题后进入辩手选择流程，支持 IT 模板快速发起。

### 3) 场景选择 + 智能推荐
![场景选择与智能推荐](./images/screenshot-03.png)
说明：先选场景，再点击“智能推荐”触发 LLM；也可完全手动选人。

### 4) 辩论过程（逐条发言）
![辩论过程](./images/screenshot-04.png)
说明：辩手按轮次依次发言，内容为 Markdown 渲染，便于阅读和复盘。

### 5) 裁判阶段结论
![裁判阶段结论](./images/screenshot-05.png)
说明：给出当前阶段最优结论、置信度及关键决策信息。

### 6) 简历解析 + 评审结果
![简历解析与评审](./images/screenshot-06.png)
说明：支持仅解析预览，或进入多 Agent 评审并输出评分与建议。

### 7) 历史评审详情
![历史评审详情](./images/screenshot-07.png)
说明：可回看历史评审，查看当次岗位、结论、评审意见与文本信息。

### 8) 综合业务视图
![综合业务视图](./images/screenshot-08.png)
说明：展示辩论与评审能力在统一系统中的协同应用效果。
